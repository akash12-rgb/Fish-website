...
<div class="container my-5">
  ...
  <div class="row g-5">
    ...
    <div class="col-lg-7">
      ...
      <h1 style="font-family:'Playfair Display',serif;font-weight:900;font-size:clamp(1.8rem,4vw,2.5rem)"><?= htmlspecialchars($p['product_name']) ?></h1>
      <div class="product-price mb-3" style="font-size:2rem">Rs <?= number_format($p['price'], 0, ',', '.') ?></div>

      <p class="text-muted lh-lg"><?= nl2br(htmlspecialchars($p['description'])) ?></p>
      ...
      <?php if ($p['stock_quantity'] > 0): ?>
        ...
        <div class="d-flex gap-3 flex-wrap">
          ...
          <a href="checkout.php?buy_now=<?= $p['id'] ?>&qty=1" class="btn btn-lg text-decoration-none"
      ...
      <div class="row g-2 mt-4">
        <?php foreach ([['🚚', 'Free delivery on orders above Rs 200k'], ['🔒', 'Secure ICICI Orange Pay'], ['✅', '100% Fresh Guaranteed']] as $b): ?>
          ...
          <div class="col-6 col-md-3">
            <div class="product-card">
              ...
              <div class="card-body">
                ...
                <div class="product-price mb-2">Rs <?= number_format($r['price'], 0, ',', '.') ?></div>
                <button class="btn-cart w-100" onclick="addToCart(<?= $r['id'] ?>)">Add to Cart</button>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
